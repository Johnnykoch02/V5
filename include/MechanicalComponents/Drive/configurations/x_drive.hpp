...
#ifndef X_DRIVE_H
#define X_DRIVE_H
#include "../../TerriBull/lib/Vector2.hpp"
#include "../drive.hpp"
#include "../../../main.h"
#include <cmath>
#include <string>
...
class X_Drive : public TerriBull::Drive {
    ...
    void setVoltage(float* voltages, float lt, float lb, float rt, float rb);

    // float dError();
      
    void reset();
    // std::string getType() {return "x_drive"; }
...
//       case 4:
//         dir = (angle < 90) ? 1 : -1;
//         this->setVoltage(voltages, pct*dir, -pct*dir, pct*dir, pct*-dir);
//         break;
//       case 1:
//       case 5:
//         dir = (angle < 125) ? 1 : -1;
//         this->setVoltage(voltages, dir*pct, 0, 0,dir*pct);
//         break;
//       case 2:
//       case 6:
//         dir = (angle < 180) ? 1 : -1;
//         this->setVoltage(voltages, dir*pct, dir*pct, dir*pct,dir*pct);
//         break;
//       case 3:
//       case 7:
//         dir = (angle < 215) ? 1 : -1;
//         this->setVoltage(voltages, 0, -dir*pct, -dir*pct,0);
//         break;
//         default:
...
//     pros::lcd::set_text(4, "Finished Loop" );
...
//   this->setVoltage(nullptr, pct*dir, 0, 0, -pct*dir);
//   this->previousError = this->currentError;
// }
...
//   // x_drive_motors_set_voltages(pA, pB, pC, pD, 0, 0, 0, 0);
// }
